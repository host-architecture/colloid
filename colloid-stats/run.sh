...
for i in 8 4 2 1; do
    for lmem in 24576 19661 14746 9830 4915; do
        ...
        insmod /home/midhul/colloid/memeater/memeater.ko sizeMiB=$eatmem;
        cat /sys/devices/system/node/node3/meminfo | grep "MemFree";
        /home/midhul/mio-colloid/gups/gups-rw $i &
        pid_gups=$!;
        taskset -c 0 /home/midhul/mio-colloid/colloid-stats/record_stats > /home/midhul/membw-eval/$config_rw-cores$i-lmem$lmem.stats.txt 2>&1 &
        pid_stats=$!;
        sleep 1000;
        killall record_stats;
...
for i in 8 4 2 1; do
    for lmem in 24576 19661 14746 9830 4915; do
        ...
        pid_gups=$!;
        taskset -c 0 /home/midhul/mio-colloid/colloid-stats/record_stats > /home/midhul/membw-eval/$config_r-cores$i-lmem$lmem.stats.txt 2>&1 &
        pid_stats=$!;
        sleep 1000;
        killall record_stats;
        while kill -0 $pid_stats; do

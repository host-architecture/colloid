...
#		MIO_STATS="--stats_colloid --stats_colloid_cha --stats_colloid_wait 560" ./linux.sh icx-mtv-linux-gups64-rw-app$i-bg$b 600 $i $b -- /home/midhul/colloid/gups/gups64-rw $i;
#	done;
#done;

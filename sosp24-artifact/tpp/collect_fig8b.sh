...
for b in 0 5 10 15; do
    tpp_output=$(cat $stats_path/tpp-silo-ycsb-app15-bg$b.app.txt | grep -iv 'total' | awk '{print $1}')
    tpp_colloid_output=$(cat $stats_path/tpp-colloid-silo-ycsb-app15-bg$b.app.txt | grep -iv 'total' | awk '{print $1}')
